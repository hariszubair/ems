...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit your leave</h1>
    </div>
    <div class="container">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('leaves.update', $leave->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="from" type="date" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                        ...
                                        value="{{ $leave->from }}" required autocomplete="from" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="to" type="date" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                        ...
                                        value="{{ $leave->to }}" required autocomplete="to" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="type" type="text"
                                        ...
                                        <option {{ $leave->type == 'Casual' ? 'selected' : '' }} value="Casual">Casual
                                        </option>
                                        <option {{ $leave->type == 'Annual' ? 'selected' : '' }} value="Annual">Annual
                                        </option>
                                    </select>
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="reason" name="reason" rows="2" class="form-control" style="resize: none">{{ $leave->reason }}</textarea>
